...
{
    internal static class AddCloneRepoAndAddLambdaExtension
    {
        internal static void AddCloneRepoAndAddLambda(this IServiceCollection services)
        {
            ...
            services.AddSingletonIfNotExists<IAddNewLambdaServiceStrategy, CloneRepoAndAddLambda>();
        }
    }

    internal class CloneRepoAndAddLambda(IConsoleService consoleService,
                                          IGitService git,
                                          IDotNet dotNet,
                                          ...
                                          IRunJitApiClientFactory runJitApiClientFactory) : IAddNewLambdaServiceStrategy
    {
