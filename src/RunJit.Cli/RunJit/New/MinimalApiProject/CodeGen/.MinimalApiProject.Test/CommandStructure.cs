...
//namespace RunJit.Cli.New.MinimalApiProject.CodeGen.MinimalApiProject.Test
//{
...
//        {
//            await CreateTestsForCommandAsync(projectFileInfo, projectDocument, dotNetToolInfos, dotNetToolInfos.CommandInfo, null, string.Empty);
