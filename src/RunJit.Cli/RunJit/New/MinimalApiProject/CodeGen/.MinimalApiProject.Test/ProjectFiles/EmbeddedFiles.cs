...
namespace RunJit.Cli.New.MinimalApiProject.CodeGen.MinimalApiProject.Test.ProjectFiles
{
    internal static class AddProjectEmbeddedFilesCodeGenExtension
    {
        internal static void AddProjectEmbeddedFilesCodeGen(this IServiceCollection services)
        {
            ...
            services.AddSingletonIfNotExists<IMinimalApiProjectTestSpecificCodeGen, ProjectEmbeddedFilesCodeGen>();
        }
    }

    internal sealed class ProjectEmbeddedFilesCodeGen(ConsoleService consoleService) : IMinimalApiProjectTestSpecificCodeGen
    {
