...
{
    internal static class AddProjectCreationCheckListCodeGenExtension
    {
        internal static void AddProjectCreationCheckListCodeGen(this IServiceCollection services)
        {
            services.AddConsoleService();
            services.AddNamespaceProvider();

            services.AddSingletonIfNotExists<IMinimalApiProjectRootLevelCodeGen, ProjectCreationCheckListCodeGen>();
        }
    }

    internal sealed class ProjectCreationCheckListCodeGen(ConsoleService consoleService) : IMinimalApiProjectRootLevelCodeGen
    {
