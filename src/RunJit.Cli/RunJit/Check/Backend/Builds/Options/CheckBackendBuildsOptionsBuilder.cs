...
{
    public static class AddCheckBackendBuildsOptionsBuilderExtension
    {
        public static void AddCheckBackendBuildsOptionsBuilder(this IServiceCollection services)
        {
