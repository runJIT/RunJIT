...
{
    internal static class AddUpdateResharperSettingsOptionsBuilderExtension
    {
        internal static void AddUpdateResharperSettingsOptionsBuilder(this IServiceCollection services)
        {
