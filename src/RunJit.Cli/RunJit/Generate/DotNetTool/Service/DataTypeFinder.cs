...
namespace RunJit.Cli.RunJit.Generate.DotNetTool
{
    ...
    public class DataTypeFinder
    {
                                                                ...
                                                                IImmutableList<CSharpSyntaxTree> syntaxTrees)
        {
            ...
            var allGenericTypes = declaredTypes.SelectMany<Type, Type>(declaredType => declaredType.GetAllGenericArguments()).ToImmutableList();
            ...
            var allModels = allTypesWithAllSubTypes.Select<Type, (DeclarationBase? Declaration, Type Type)>(type => syntaxTrees.FindDataType(type))
