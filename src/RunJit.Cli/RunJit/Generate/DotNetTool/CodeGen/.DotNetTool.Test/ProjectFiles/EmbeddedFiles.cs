...
namespace RunJit.Cli.Generate.DotNetTool.DotNetTool.Test
{
    internal static class AddProjectEmbeddedFilesCodeGenExtension
    {
        internal static void AddProjectEmbeddedFilesCodeGen(this IServiceCollection services)
        {
            ...
            services.AddSingletonIfNotExists<IDotNetToolTestSpecificCodeGen, ProjectEmbeddedFilesCodeGen>();
        }
    }

    internal sealed class ProjectEmbeddedFilesCodeGen(ConsoleService consoleService) : IDotNetToolTestSpecificCodeGen
    {
