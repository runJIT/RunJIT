        ...
        internal IImmutableList<Type> GetAllTypesFrom(SolutionFile parsedSolution)
        {
            ...
            if (assembly.IsNull())
            {
                throw new RunJitException(
                    $"Your project: '{webAppProject.ProjectFileInfo.Value.FullName}' path does not contain the matching assembly: '{assembly}'. Please build your project or solution before you want to create a client from");
            }
