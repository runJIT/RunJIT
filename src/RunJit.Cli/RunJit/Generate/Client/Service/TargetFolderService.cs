...
namespace RunJit.Cli.RunJit.Generate.Client
{
    ...
    internal interface ITargetFolderService
    {
        ...
        DirectoryInfo GetToolFolder(Client client, DirectoryInfo targetDirectoryInfo);
        FileInfo GetSolutionFile(Client client, DirectoryInfo targetDirectoryInfo);
    }
    ...
    internal class TargetFolderService : ITargetFolderService
    {
        ...
        public DirectoryInfo GetToolFolder(Client client, DirectoryInfo targetDirectoryInfo)
        {
        ...
        public FileInfo GetSolutionFile(Client client, DirectoryInfo targetDirectoryInfo)
        {
            if (targetDirectoryInfo.NotExists())
            {
                throw new RunJitException($"The directory: '{targetDirectoryInfo.FullName}' does not exists.");
