...
namespace RunJit.Cli.RunJit.Generate.Client
{
    ...
    public class MethodBuilder(IBuiltInTypeTableService builtInTypeTableService)
    {
        ...
        public string BuildFor(MethodInfos methodInfo, ControllerInfo controllerInfo)
        {
            ...
            var httpClientCall = _httpActionWithPayloads.Contains(methodInfo.HttpAction) ? $"{methodInfo.HttpAction}AsJson" : methodInfo.HttpAction;
