...
namespace RunJit.Cli.Services.Resharper
{
                                              ...
                                              ConsoleService consoleService)
    {
        ...
        //    // 6. Run R# code cleanup
        //    consoleService.WriteInfo($"Start code cleanup for solution: {projectFile.FullName}");
        //    var cleanupResult = await dotnetTool.RunAsync(jbTool.FullName, $"cleanupcode {projectFile.FullName} --settings={dotSettingsFile.FullName}").ConfigureAwait(false);

        //    // 7. Print execution result
        //    if (cleanupResult.ExitCode == 0)
        //    {
        //        consoleService.WriteSuccess($"Code cleanup in solution {projectFile.FullName} was successful");
        //    }
        //    else
        //    {
        //        consoleService.WriteError($"Code cleanup in solution {projectFile.FullName} failed");
        //    }
        //}
    }
}
